                ...
                })
        {
            ...
            let pool_id = match starknet::core::types::Felt::cairo_deserialize(
                ...
                Err(e) => {
                    return Err(
                        format!(
                            "Could not deserialize field {} for {}: {:?}", "pool_id",
                            "LiquidatePosition", e
                        ),
                    );
                }
            ...
            let debt_asset = match cainome::cairo_serde::ContractAddress::cairo_deserialize(
                ...
                Err(e) => {
                    return Err(
                        format!(
                            "Could not deserialize field {} for {}: {:?}", "debt_asset",
                            "LiquidatePosition", e
                        ),
                    );
                }
            ...
            let residual = match cainome::cairo_serde::U256::cairo_deserialize(
                ...
                Err(e) => {
                    return Err(
                        format!(
                            "Could not deserialize field {} for {}: {:?}", "residual",
                            "LiquidatePosition", e
                        ),
                    );
                }
            ...
            let debt_delta = match cainome::cairo_serde::U256::cairo_deserialize(
                ...
                Err(e) => {
                    return Err(
                        format!(
                            "Could not deserialize field {} for {}: {:?}", "debt_delta",
                            "LiquidatePosition", e
                        ),
                    );
                }
