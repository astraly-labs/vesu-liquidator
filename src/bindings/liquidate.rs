...
impl cainome::cairo_serde::CairoSerde for ISingletonDispatcher {
    ...
    fn cairo_deserialize(
        ...
        let contract_address =
            cainome::cairo_serde::ContractAddress::cairo_deserialize(__felts, __offset)?;
        __offset += cainome::cairo_serde::ContractAddress::cairo_serialized_size(&contract_address);
        Ok(ISingletonDispatcher { contract_address })
    }
}
#[derive(Debug, PartialEq, PartialOrd, Clone, serde::Serialize, serde::Deserialize)]
...
impl cainome::cairo_serde::CairoSerde for LiquidateResponse {
    ...
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        let mut __size = 0;
        __size += cainome::cairo_serde::U256::cairo_serialized_size(&__rust.liquidated_collateral);
        __size += cainome::cairo_serde::U256::cairo_serialized_size(&__rust.repaid_debt);
        __size += cainome::cairo_serde::U256::cairo_serialized_size(&__rust.residual_collateral);
        __size
    }
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet::core::types::Felt> {
        let mut __out: Vec<starknet::core::types::Felt> = vec![];
    ...
    fn cairo_deserialize(
        ...
        __offset += cainome::cairo_serde::U256::cairo_serialized_size(&liquidated_collateral);
        let repaid_debt = cainome::cairo_serde::U256::cairo_deserialize(__felts, __offset)?;
        __offset += cainome::cairo_serde::U256::cairo_serialized_size(&repaid_debt);
        let residual_collateral = cainome::cairo_serde::U256::cairo_deserialize(__felts, __offset)?;
        __offset += cainome::cairo_serde::U256::cairo_serialized_size(&residual_collateral);
...
impl cainome::cairo_serde::CairoSerde for LiquidatePosition {
    ...
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        ...
        __size +=
            cainome::cairo_serde::ContractAddress::cairo_serialized_size(&__rust.collateral_asset);
        ...
        __size += cainome::cairo_serde::U256::cairo_serialized_size(&__rust.collateral_delta);
    ...
    fn cairo_deserialize(
        ...
        let collateral_delta = cainome::cairo_serde::U256::cairo_deserialize(__felts, __offset)?;
        __offset += cainome::cairo_serde::U256::cairo_serialized_size(&collateral_delta);
        let debt_delta = cainome::cairo_serde::U256::cairo_deserialize(__felts, __offset)?;
...
impl cainome::cairo_serde::CairoSerde for LiquidateParams {
    ...
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        ...
        __size +=
            cainome::cairo_serde::U256::cairo_serialized_size(&__rust.min_collateral_to_receive);
    ...
    fn cairo_deserialize(
        ...
        let min_collateral_to_receive =
            cainome::cairo_serde::U256::cairo_deserialize(__felts, __offset)?;
        __offset += cainome::cairo_serde::U256::cairo_serialized_size(&min_collateral_to_receive);
...
impl cainome::cairo_serde::CairoSerde for Event {
    ...
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        match __rust {
            Event::LiquidatePosition(val) => LiquidatePosition::cairo_serialized_size(val) + 1,
            _ => 0,
        }
    }
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet::core::types::Felt> {
    ...
    fn cairo_deserialize(
        ...
        match __index as usize {
            0usize => Ok(Event::LiquidatePosition(
                ...
                .unwrap_or_else(|_| panic!("Invalid selector for {}", "LiquidatePosition"))
        {
            ...
            let collateral_asset = match cainome::cairo_serde::ContractAddress::cairo_deserialize(
                ...
                Err(e) => {
                    return Err(format!(
                        "Could not deserialize field {} for {}: {:?}",
                        "collateral_asset", "LiquidatePosition", e,
                    ));
                }
            };
            key_offset +=
                cainome::cairo_serde::ContractAddress::cairo_serialized_size(&collateral_asset);
            let debt_asset = match cainome::cairo_serde::ContractAddress::cairo_deserialize(
                ...
                Err(e) => {
                    return Err(format!(
                        "Could not deserialize field {} for {}: {:?}",
                        "debt_asset", "LiquidatePosition", e,
                    ));
                }
            };
            key_offset += cainome::cairo_serde::ContractAddress::cairo_serialized_size(&debt_asset);
            let user = match cainome::cairo_serde::ContractAddress::cairo_deserialize(
                ...
                Err(e) => {
                    return Err(format!(
                        "Could not deserialize field {} for {}: {:?}",
                        "user", "LiquidatePosition", e,
                    ));
                }
            };
            key_offset += cainome::cairo_serde::ContractAddress::cairo_serialized_size(&user);
            let residual =
            ...
            let collateral_delta =
                match cainome::cairo_serde::U256::cairo_deserialize(&event.data, data_offset) {
                    ...
                    Err(e) => {
                        return Err(format!(
                            "Could not deserialize field {} for {}: {:?}",
                            "collateral_delta", "LiquidatePosition", e,
                        ));
                    }
                };
            data_offset += cainome::cairo_serde::U256::cairo_serialized_size(&collateral_delta);
            let debt_delta =
                match cainome::cairo_serde::U256::cairo_deserialize(&event.data, data_offset) {
                    Ok(v) => v,
                    Err(e) => {
                        return Err(format!(
                            "Could not deserialize field {} for {}: {:?}",
                            "debt_delta", "LiquidatePosition", e,
                        ));
                    }
                };
            data_offset += cainome::cairo_serde::U256::cairo_serialized_size(&debt_delta);
            return Ok(Event::LiquidatePosition(LiquidatePosition {
                pool_id,
                collateral_asset,
                debt_asset,
                user,
...
impl<A: starknet::accounts::ConnectedAccount + Sync> Liquidate<A> {
    ...
    pub fn liquidate_getcall(&self, params: &LiquidateParams) -> starknet::accounts::Call {
        use cainome::cairo_serde::CairoSerde;
    ...
    #[allow(clippy::ptr_arg)]
    #[allow(clippy::too_many_arguments)]
    pub fn liquidate(&self, params: &LiquidateParams) -> starknet::accounts::ExecutionV1<A> {
        use cainome::cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata.extend(LiquidateParams::cairo_serialize(params));
