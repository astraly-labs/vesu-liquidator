...
impl MonitoringService {
    ...
    async fn compute_profitability(&self, position: &Position) -> Result<(BigDecimal, Vec<Call>)> {
        ...
        let debt_to_liquidate = liquidable_amount_as_debt_asset.clone() * liquidation_factor.clone();
        let min_collateral_to_receive = liquidable_amount_as_collateral_asset * liquidation_factor.clone();
